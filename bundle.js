...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function Ev(i,e,t){let n=new Float32Array($s),s=new R(0,1,0);return new Sn({name:"SphericalGaussianBlur",defines:{n:$s,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:kl(),fragmentShader:`
