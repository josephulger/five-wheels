...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function lv(i,e,t){let n=new Float32Array(Ks),s=new R(0,1,0);return new Mn({name:"SphericalGaussianBlur",defines:{n:Ks,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Nl(),fragmentShader:`
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function Kp(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Nl(),fragmentShader:`
		...
		`,blending:Ai,depthTest:!1,depthWrite:!1})}function Zp(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Nl(),fragmentShader:`
	...
	`}var Pl=class extends yn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Go(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var uM={[iu]:"Linear",[su]:"Reinhard",[ru]:"Cineon",[ra]:"ACESFilmic",[au]:"AgX",[cu]:"Neutral",[ou]:"Custom"};function dM(i,e){let t=uM[e];return t===void 0?(Ne("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Il=new R;function fM(){$e.getLuminanceCoefficients(Il);let i=Il.x.toFixed(4),e=Il.y.toFixed(4),t=Il.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}var bM={[ia]:"SHADOWMAP_TYPE_PCF",[Gr]:"SHADOWMAP_TYPE_VSM"};function SM(i){return bM[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var AM={[ms]:"ENVMAP_TYPE_CUBE",[Xs]:"ENVMAP_TYPE_CUBE",[oa]:"ENVMAP_TYPE_CUBE_UV"};function wM(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":AM[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var TM={[Xs]:"ENVMAP_MODE_REFRACTION"};function EM(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":TM[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var CM={[Gc]:"ENVMAP_BLENDING_MULTIPLY",[Tp]:"ENVMAP_BLENDING_MIX",[Ep]:"ENVMAP_BLENDING_ADD"};function RM(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":CM[i.combine]||"ENVMAP_BLENDING_NONE"}function IM(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function PM(i,e,t,n){let s=i.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,c=SM(t),l=wM(t),h=EM(t),u=RM(t),d=IM(t),f=pM(t),g=mM(r),x=s.createProgram(),p,m,M=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(_a).join(`
`)),o=Nu(o),o=rm(o,t),o=om(o,t),a=Nu(a),a=rm(a,t),a=om(a,t),o=am(o),a=am(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
#endif`;Ie.instanced_pars_vertex=Sb;Ie.instanced_color_pars_vertex=Ab;Ie.instanced_vertex=wb;Ie.instanced_color_vertex=Tb;function Zu(i){return i.replace("#ifdef USE_INSTANCING","#if defined USE_INSTANCING || defined USE_INSTANCING_INDIRECT")}Ie.project_vertex=Zu(Ie.project_vertex);Ie.worldpos_vertex=Zu(Ie.worldpos_vertex);Ie.defaultnormal_vertex=Zu(Ie.defaultnormal_vertex);Ie.batching_pars_vertex=Ie.batching_pars_vertex.concat(`
