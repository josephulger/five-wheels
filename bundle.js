...
`)}var CM={[xu]:"Linear",[_u]:"Reinhard",[yu]:"Cineon",[ha]:"ACESFilmic",[Mu]:"AgX",[bu]:"Neutral",[vu]:"Custom"};function RM(i,e){let t=CM[e];return t===void 0?(Ne("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Bl=new R;function IM(){je.getLuminanceCoefficients(Bl);let i=Bl.x.toFixed(4),e=Bl.y.toFixed(4),t=Bl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Sa).join(`
`)),o=Yu(o),o=xm(o,t),o=_m(o,t),a=Yu(a),a=xm(a,t),a=_m(a,t),o=ym(o),a=ym(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
#endif`;Pe.instanced_pars_vertex=kb;Pe.instanced_color_pars_vertex=Vb;Pe.instanced_vertex=Gb;Pe.instanced_color_vertex=Hb;function ld(i){return i.replace("#ifdef USE_INSTANCING","#if defined USE_INSTANCING || defined USE_INSTANCING_INDIRECT")}Pe.project_vertex=ld(Pe.project_vertex);Pe.worldpos_vertex=ld(Pe.worldpos_vertex);Pe.defaultnormal_vertex=ld(Pe.defaultnormal_vertex);Pe.batching_pars_vertex=Pe.batching_pars_vertex.concat(`
